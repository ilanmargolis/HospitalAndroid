...
public class LeitoDadosActivity extends AppCompatActivity {
    ...
    private EditText etCodigoLeito;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etCodigoLeito = (EditText) findViewById(R.id.etCodigoLeito);
...
//        carregaSpinner();
        ...
        btLeitoOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String codigoLeito = etCodigoLeito.getText().toString().trim();
                ...
                if (leito.getId() == 0) { // inclusão
                    ...
                    if (!leito.getCodigo().equalsIgnoreCase(etCodigoLeito.getText().toString().trim())) {
                        leito.setCodigo(codigoLeito);
...
//            spUnidade.setSelection(0);
            ...
            etCodigoLeito.setText(leito.getCodigo());
    ...
    private void carregaSpinner() {
        ...
        spUnidade.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                leito.setUnidade((Unidade) spUnidade.getItemAtPosition(position));
            }
